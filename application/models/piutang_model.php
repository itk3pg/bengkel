...
class Piutang_model extends CI_Model{
	...
	function getDataBOKuitansi($data){
		$query = "select b.nama_pelanggan, a.no_kuitansi, a.keterangan_kuitansi, round(sum((a.jumlah/1.11)),2) as dpp, round(sum((a.jumlah/1.11)*0.11),2) as ppn from piutang a left join pelanggan b on a.pelanggan_kode=b.kode where a.no_kuitansi='".$data['no_kuitansi']."'";
