<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
			...
			<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0011" || $this->session->userdata('username') == "KW94051" || $this->session->userdata('group_kode') == "GRU0007" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0009"){ ?>
            <li id="setting">
            ...
            <?php } ?>
            <?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0001" || $this->session->userdata('group_kode') == "GRU0002" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0004" || $this->session->userdata('group_kode') == "GRU0005" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0007" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0009" || $this->session->userdata('group_kode') == "GRU0010" || $this->session->userdata('group_kode') == "GRU0012"){ ?>
            <li id="master">
                <a href="#"><i class="fa fa-table fa-fw"></i> Master<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
					<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0003"){ ?>
					<li id="user">
            ...
            <?php } ?>
            <?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0001" || $this->session->userdata('group_kode') == "GRU0002" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0004" || $this->session->userdata('group_kode') == "GRU0005" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0009" || $this->session->userdata('group_kode') == "GRU0010" || $this->session->userdata('group_kode') == "GRU0011" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0007"){ ?>
            <li id="transaksi">
                <a href="#"><i class="fa fa-money fa-fw"></i> Transaksi<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
					<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0009" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0007"){ ?>
					...
					<?php } ?>
					<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0009" || $this->session->userdata('group_kode') == "GRU0001" || $this->session->userdata('group_kode') == "GRU0002" || $this->session->userdata('group_kode') == "GRU0004" || $this->session->userdata('group_kode') == "GRU0005" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0007"){ ?>
					<li id="ordertransfer">
					...
					<?php } ?>
					<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0001" || $this->session->userdata('group_kode') == "GRU0002" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0004" || $this->session->userdata('group_kode') == "GRU0005" || $this->session->userdata('group_kode') == "GRU0009" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0007"){ ?>
					<li id="returtoko">
                    ...
                    <?php } ?>
                    <?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0010" || $this->session->userdata('group_kode') == "GRU0007" || $this->session->userdata('username') == "402" || $this->session->userdata('username') == "ANGGAR"){ ?>
					...
					<?php } ?>
					<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0012"  || $this->session->userdata('group_kode') == "GRU0005"){ ?>
					<!-- <li id="kasbank">
                        <a href="<?php echo base_url(); ?>index.php/kasbank">Kas/Bank</a>
                    </li> -->
					<?php } ?>
					<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0010" || $this->session->userdata('group_kode') == "GRU0011" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0007" || $this->session->userdata('username') == "402" || $this->session->userdata('username') == "403"){ ?>
					<li id="permintaanpembayaran">
                        <a href="<?php echo base_url(); ?>index.php/permintaanpembayaran">Permintaan Pembayaran (PB)</a>
                    </li>
					<?php } ?>
					<?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0010" || $this->session->userdata('group_kode') == "GRU0011" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0007"){ ?>
            ...
            <?php } ?>
            <?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0001" || $this->session->userdata('group_kode') == "GRU0002" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0004" || $this->session->userdata('group_kode') == "GRU0005" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0007" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0009" || $this->session->userdata('group_kode') == "GRU0010" || $this->session->userdata('group_kode') == "GRU0011" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0013"){ ?>
            <li id="laporan">
